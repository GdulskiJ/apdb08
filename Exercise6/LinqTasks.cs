...
namespace Exercise6
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000)
        ...
        {
            IEnumerable<object> result = Emps.Where(e => e.Deptno.HasValue)
                .GroupBy(e => e.Deptno)
                .Where(g => g.Count() > 1)
                .Select(g => new
                {
        ...
        {
            IEnumerable<Emp> result = Emps.MyExtension();
           return result;
        }
        ...
        {
            IEnumerable<Dept> result =  Depts.Where(d => Emps.Count(e => e.Deptno == d.Deptno) == 5 || Emps.All(e => e.Deptno != d.Deptno))
                .OrderBy(d => d.Dname);
            //result =
            return result;
        }
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> MyExtension(this IEnumerable<Emp> emps)
        {
            return emps.Where(emp1 => emps.Any(emp2 => emp2.Mgr?.Empno == emp1.Empno))
                .OrderBy(e => e.Ename)
